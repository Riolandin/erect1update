                    ...
                    <div class="form-main-wrapper">
                        ...
                        <div class="formwrapper">
                            <form>
                                ...
                                <!--- --- Password selection ----- ------  -->
                                <div class="group">
                                    <input class="input" type="password" required id="password">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                ...
                                <div class="group">
                                    <input class="input" type="text" required id="Cpassword">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                ...
                                <div class="checkboxes-wrapper">
                                    ...
                                    <div class="checkboxes">
                                        <label class="agreebox container">
                                            <input class="checkbox1" type="checkbox" required id="oksionemail">
                                    ...
                                    <div class="checkboxes">
                                        <label class="agreebox container">
                                            <input class="checkbox1" type="checkbox" required id="okterms">
                                            <span class="checkmark"></span>
                                        </label>
                                ...
                                <p class="btncon"><button type="button" id="regbtn"
                                        class="w3-button w3-teal w3-round-large w3-hover-light-blue submitbtn">
                                        <label id="current" class="current">
                                            Create
                                            account
                                        </label>
